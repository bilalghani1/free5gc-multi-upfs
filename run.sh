...
NF_LIST="nrf amf udr pcf udm nssf ausf chf nef"
...
#./bin/smf -c ./config/multiUPF/smfcfg_multi.yaml &
./bin/smf -c ./config/multiUPF/smfcfg_multi.yaml -uerouting ./config/multiUPF/uerouting.yaml &
PID=$!
PID_LIST+=($PID)
echo "Started SMF with PID ${PID}"
sleep 0.1
